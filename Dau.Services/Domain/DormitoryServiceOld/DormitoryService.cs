...
namespace Dau.Services.DormitoryServiceOld
{
   public class DormitoryService : IDormitoryService
   {
    //    private readonly IRepository<DormitoriesTable> _dormitoryRepository;

    //    // private Fees_and_facilitiesContext _context = new Fees_and_facilitiesContext();

    //    public DormitoryService(IRepository<DormitoriesTable> DormitoryRepository)
    //    {
