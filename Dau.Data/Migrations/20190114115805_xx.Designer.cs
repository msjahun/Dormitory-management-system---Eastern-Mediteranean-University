            ...
            modelBuilder.Entity("Dau.Core.Domain.Users.UsersDormitory", b =>
                {
                    ...
                    b.Property<long>("DormitoryId2");

                    b.Property<string>("DormitoryUserId")
                        .IsRequired();

                    b.HasKey("Id", "UserId", "DormitoryId");

                    b.HasIndex("UserId");

                    b.HasIndex("DormitoryId1", "DormitoryUserId", "DormitoryId2");
            ...
            modelBuilder.Entity("Dau.Core.Domain.Users.UsersDormitory", b =>
                {
                    ...
                    b.HasOne("Dau.Core.Domain.Users.UsersDormitory", "Dormitory")
                        .WithMany()
                        .HasForeignKey("DormitoryId1", "DormitoryUserId", "DormitoryId2")
                        .OnDelete(DeleteBehavior.Cascade);
                });
